...
VOLC_API_BASE  = get("VOLC_API_BASE", "http://10.60.2.31/ai-gateway/szzx_openclaw/qianwen")
VOLC_MODEL     = get("VOLC_MODEL", "Qwen2.5-32B-Instruct")
